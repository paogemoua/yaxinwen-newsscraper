 $(document).ready(function() {
    ...
    $.getJSON("./articles", function(data) {
        for (var i = 0; i < data.length; i++) {
            $("#scrape-results").prepend("<div class='result-div'><p class='result-text'>" + data[i].description + 
    ...
    $(document).on("click", ".save-article", function() {
        $(this).children("span.icon").children("i.fa-bookmark").removeClass("fa-bookmark").addClass("fa-check-square-o");
